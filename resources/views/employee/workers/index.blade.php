...
@section('usercontent')
					...
					<div class="panel-body"> 
						<div class = "row"> 
							<div class = "col-sm-3 toolbar-left text-left"> 
								<form method = "get" action = "{{ route('employeeworkers') }}">
									Sort by :
									<div class="select" >
							...
							<div class = "col-sm-3 toolbar-left text-left">
								<form  class="form-horizontal" method = "get" action = "{{ route('employeeworkers') }}"> 
	...
	<script>
		...
		$(document).on('click', '.viewinfo' , function(){ 
			 $.ajax({
				url: '{!! route('employeeemployeedetail') !!}',
				type: 'POST',
