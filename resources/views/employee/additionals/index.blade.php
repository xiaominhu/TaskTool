					...
					<div class="panel-body"> 
						<div class = "row">
							...
							<div class = "col-sm-3 toolbar-left text-left">
								<form method = "get" action = "{{ route('employeeadditionals') }}">
									Sort by :
									<div class="select" >
							...
							<div class = "col-sm-3 toolbar-left text-left">
								<form  class="form-horizontal" method = "get" action = "{{ route('employeeadditionals') }}"> 
							...
							<div class = "col-sm-6">
								<div class = "text-right">
									<a href = "{{ route('employeeadditionalscreate') }}" class="btn btn-primary btn-fill btn-wd">Add New Addtional Job</a>  
								</div>
							</div>   
						</div>  
										...
										<tr> 
											...
											<td>
												<div class="btn-group btn-group-sm">  
													...
													<a  href = "javascript: void(0)" data-url = "{!! route('employeeadditionalsdelete', $task->id) !!}" class="btn btn-danger deleteaction"><i class="fa  fa-times"></i></a>
												</div>
											</td>							  				 
										</tr> 
									@empty 
	...
	@push('scripts')
		...
		<script>
			...
			$("select[name='sort']").change(function(){
				var url = "{!! route('employeeadditionals')!!}?";
			 ...
			 $(document).on('click', '.viewinfo' , function(){ 
				var obj = $(this);
				 $.ajax({
					url: '{!! route('employeeadditionalsdetail') !!}',
					type: 'POST',
