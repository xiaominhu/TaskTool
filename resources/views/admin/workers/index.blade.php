...
@section('usercontent')
	 <div id="page-head">
		<div id="page-title">
			<h1 class="page-header text-overflow"> Employee Management </h1>
		</div>
		<ol class="breadcrumb">
					...
					<div class="panel-body"> 
						<div class = "row"> 
							<div class = "col-sm-3 toolbar-left text-left">
								<form  class="form-horizontal" method = "get" action = "{{ route('adminworkers') }}">
									Sort by :
									<div class="select" >
							...
							<div class = "col-sm-6">
								<div class = "text-right">
									<a href = "{{ route('adminworkerscreate') }}" class="btn btn-primary btn-fill btn-wd">Add New Employee</a>  
								</div>
							</div>   
						</div>  
										...
										<tr>  
											...
											<td>
												<div class="btn-group btn-group-sm"> 
													<a  href = "{{ route('adminworkersupdate', $user->id) }}" class="btn btn-primary"><i class="fa fa-edit"></i></a> 
													<a  href = "#" class="btn btn-warning viewinfo" data-id = "{!! $user->id !!}"><i class="fa  fa-eye"></i></a> 
													<a  href = "javascript: void(0)" data-url = "{!! route('adminworkersdelete',  $user->id) !!}" class="btn btn-danger deleteaction"><i class="fa  fa-times"></i></a> 
												</div>
											</td>							  				 
										</tr>  
									@empty
										<tr> <td class = "text-center" colspan = "9"> There is no employee. </td> </tr>
									@endforelse
								</tbody>
							</table>
						</div>     
	...
	<script>
		...
		deleteconfirm_string  = "Do you want to remove this employee?";
		$(document).on('click', '.viewinfo' , function(){ 
			 $.ajax({
				url: '{!! route('adminemployeedetail') !!}',
				type: 'POST',
